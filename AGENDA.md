...
Helper(s) convention: `(CCR)` = student helper earning Co-Curricular Record credit; `(SCIPE)` = SCIPE26 Fellow; `-` = no helper needed.
...
| 9:30 AM - 11:00 AM | 1 hr 30 min | Accounts, Login, Environment, Running Jobs and Logging into Expanse User Portal | Marty Kandes  | Hadia Bayat (SCIPE), Trevor Mugoya (SCIPE) |
...
| 2:15 PM - 4:45 PM   | 2 hr 30 min | Parallel Computing using MPI & Open MP | Igor Sfiligoi       | Hadia Bayat (SCIPE)   |
...
| 1:30 PM - 4:45 PM   | 3 hr 15 min | GPU Computing and Programming           | Andreas Goetz   | Zay Htet (CCR) |
| 4:45 PM - 4:50 PM   | 5 min       | Day Survey                                                  | Andrea Zonca | -         |
