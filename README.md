...
For your convenience, we've created aliases and symlinks for the Summer Institute:
...
* `jupyter-compute-tensorflow` - start a JupyterLab session for for TensorFlow on a compute node
